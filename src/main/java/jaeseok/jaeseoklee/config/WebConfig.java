...
//    CORS 설정
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**") // 모든 경로에 대해 CORS 설정을 적용
                .allowedOrigins("http://localhost:3000", "https://jsl.comon.kr", "http://localhost:8859", "https://121.139.242.20:8859") // 허용할 도메인
                .allowedMethods("GET", "POST", "PUT", "DELETE", "PATCH") // 허용할 HTTP 메서드
                .allowedHeaders("*") // 허용할 헤더
                .allowCredentials(true); // 인증 정보를 포함할지 여부

        registry.addMapping("/swagger-ui/**")
                .allowedOrigins("http://localhost:3000", "https://jsl.comon.kr", "http://localhost:8859", "https://121.139.242.20:8859")
