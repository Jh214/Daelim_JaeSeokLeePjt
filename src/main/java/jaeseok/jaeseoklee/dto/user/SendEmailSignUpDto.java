...
public class SendEmailSignUpDto {
    ...
    public SendEmailSignUpDto(String userEmail, int ranCode, LocalDateTime timeLimit) {
    ...
    private String generateEmailContent() {
        return "<!DOCTYPE html>\n" +
                ...
                "            <p style=\"color: #000000;\">회원가입을 하기 위해<span style=\"color: #000000;\"></span> 이메일 인증코드가 필요합니다.</p>\n" +
